...
<header>
	<div class="row">
		...
		<div class="col-sm-6 text-right h2">
			...
			<a class="btn btn-default" id="atualizar-btn"><i class="fa fa-refresh"></i> Atualizar</a>
		</div>
	</div>
</header>
...
<table class="table table-hover" id="tabelaPrincipal">
	<thead>
		<tr>
			<th>ID</th>
			<th width="30%">Nome</th>
...
<script>
	$("#atualizar-btn").on("click", function(e) {
		$("#tabelaPrincipal").load("#index.php #tabelaPrincipal");
	});
</script>